            ...
            Z = {
              ...
              VIDEO: function (e, t) {
                G(e, function (e) {
                  ...
                  j(e, q),
                  K(e, u, S(e, t.data_poster)),
                  K(e, c, S(e, t.data_src)),
                  e.load();
              },
              OBJECT: function (e, t) {
                j(e, W), K(e, f, S(e, t.data_src));
              },
            },
  ...
  (() => {
    ...
    function c(e = {}, t = {}) {
      Object.keys(t).forEach((s) => {
        void 0 === e[s]
          ? (e[s] = t[s])
          : l(t[s]) && l(e[s]) && Object.keys(t[s]).length > 0 && c(e[s], t[s]);
      });
    }
    const d = {
      body: {},
            ...
            void 0 !== n &&
              ...
              (x(t[i]) && x(a[i])
                ? a[i].__swiper__
                  ...
                  : L(t[i], a[i])
                : !x(t[i]) && x(a[i])
                ? ((t[i] = {}), a[i].__swiper__ ? (t[i] = a[i]) : L(t[i], a[i]))
                : (t[i] = a[i]));
          }
        }
      }
    ...
    function H(e) {
      ...
      d && l.target && l.target.shadowRoot && u && (c = y(u[0]));
      ...
      t({
        ...
        s("click", (t, s) => {
          const { $nextEl: n, $prevEl: a } = e.navigation,
            r = s.target;
          if (e.params.navigation.hideOnClick && !y(r).is(a) && !y(r).is(n)) {
            if (
              e.pagination &&
              e.params.pagination &&
    ...
    function ce({ swiper: e, extendParams: t, on: s }) {
      ...
      function u(t) {
        ...
        e.navigation &&
          ...
          e.pagination &&
            i.is(le(e.params.pagination.bulletClass)) &&
            i[0].click();
      }
      function h() {
        return (
      ...
      const m = (e, t, s) => {
        ...
        w = () => {
          ...
          t.itemRoleDescriptionMessage &&
            l(y(e.slides), t.itemRoleDescriptionMessage),
            t.slideRole && o(y(e.slides), t.slideRole);
        ...
        s("fromEdge toEdge afterInit lock unlock", () => {
          e.params.a11y.enabled &&
            (function () {
              ...
              s &&
                s.length > 0 &&
                (e.isBeginning ? (d(s), r(s)) : (p(s), a(s))),
                t && t.length > 0 && (e.isEnd ? (d(t), r(t)) : (p(t), a(t)));
            })();
        }),
        s("paginationUpdate", () => {
          e.params.a11y.enabled &&
          ...
          function ({ swiper: e, extendParams: t, on: s, emit: i }) {
            ...
            function c() {
              ...
              if (
                ("fraction" === s.type &&
                  (c
                    .find(le(s.currentClass))
                    .text(s.formatFractionCurrent(d + 1)),
                  c.find(le(s.totalClass)).text(s.formatFractionTotal(p))),
                "progressbar" === s.type)
              ) {
                let t;
            ...
            function d() {
              ...
              if ("bullets" === t.type) {
                ...
                n.html(a), (e.pagination.bullets = n.find(le(t.bulletClass)));
              }
              "fraction" === t.type &&
                ((a = t.renderFraction
    ...
    pe.observe(document.querySelector(".art-flex")),
      document.querySelectorAll(".concept-item").forEach((e) => pe.observe(e)),
      (window.FLS = !0),
      (function (e) {
        let t = new Image();
        (t.onload = t.onerror =
