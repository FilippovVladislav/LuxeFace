(() => {
  ...
  (() => {
            ...
            void 0 !== s &&
              ...
              (T(t[n]) && T(o[n])
                ? o[n].__swiper__
                  ...
                  : _(t[n], o[n])
                : !T(t[n]) && T(o[n])
                ? ((t[n] = {}), o[n].__swiper__ ? (t[n] = o[n]) : _(t[n], o[n]))
                : (t[n] = o[n]));
          }
        }
      }
    ...
    function P({ swiper: e, targetPosition: t, side: i }) {
      const n = p(),
        s = -e.translate;
      let o,
        a = null;
    ...
    const $ = {
      ...
      updateSlides: function () {
        ...
        for (let s = 0; s < u; s += 1) {
          ...
          const a = d.eq(s);
          if (
            (x && e.grid.updateSlide(s, a, u, t), "none" !== a.css("display"))
          ) {
            if ("auto" === n.slidesPerView) {
              ...
              (S = (o - (n.slidesPerView - 1) * y) / n.slidesPerView),
                n.roundLengths && (S = Math.floor(S)),
        ...
        if (
          ...
          x && e.grid.updateWrapperSize(S, h, t),
          !n.centeredSlides)
        ) {
          const t = [];
    ...
    const j = {
      loopCreate: function () {
        ...
        for (let e = 0; e < r.length; e += 1)
          s.append(C(r[e].cloneNode(!0)).addClass(i.slideDuplicateClass));
        for (let e = a.length - 1; e >= 0; e -= 1)
    ...
    function N(e) {
      ...
      d && l.target && l.target.shadowRoot && h && (c = C(h[0]));
    ...
    const J = {
      setBreakpoint: function () {
        ...
        h && i && e.changeDirection(), _(e.params, l);
      ...
      t({
        ...
        i("click", (t, i) => {
          const { $nextEl: s, $prevEl: o } = e.navigation,
            a = i.target;
          if (e.params.navigation.hideOnClick && !C(a).is(o) && !C(a).is(s)) {
            if (
              e.pagination &&
              e.params.pagination &&
      ...
      const m = (e, t, i) => {
        ...
        y = () => {
          ...
          t.itemRoleDescriptionMessage &&
            l(C(e.slides), t.itemRoleDescriptionMessage),
            t.slideRole && r(C(e.slides), t.slideRole);
    ...
    class Ge extends Pe {
      ...
      onPointerMove(e, t, i) {
        ...
        m < 0.5 * g && (d = Math.max(d, g)),
          ...
          "y" === this.lockedAxis && pe(m) === pe(g) && (u = 0),
          "x" === this.lockedAxis && pe(m) === pe(g) && (h = 0),
          this.applyChange({
            originX: a,
            originY: r,
            panX: u,
        ...
        o &&
          ...
          (this.contentRect = Object.assign(
            Object.assign({}, this.contentRect),
            {
              ...
              left: v.left - a.left + C,
              right: a.right - v.right + C,
              fitWidth: b,
              fitHeight: y,
              width: b,
              height: y,
      ...
      reset(e) {
        if (this.state !== Le.Init && this.state !== Le.Destroy) {
          this.stop("current");
          for (const e of Oe) this.target[e] = Be[e];
    ...
    class lt extends Pe {
      ...
      processOptions() {
        ...
        if (s && Se(s))
          for (const [e, t] of Object.entries(s))
            window.matchMedia(e).matches && Se(t) && ((n += e), Te(i, t));
      ...
      removeSlideEl(e, t = !1) {
        ...
        const n = this.cn(at);
        if (
          (i.classList.contains(n) && ($e(i, n), this.emit("unselectSlide", e)),
          e.isDom && !t)
        )
          return (
            ...
            n &&
              ...
              n.classList.contains("f-thumbs__slide")
                ...
                ? (n.classList.contains(t) ||
                  ...
                  n.removeAttribute(e))
                : (n.classList.contains(t) &&
                    ($e(n, t), this.emit("unselectSlide", i)),
                  n.setAttribute(e, "true")));
          }
      }
      flipInfiniteTrack() {
    ...
    const Et = () => {
      ...
      Tt = () => {
        ...
        const { slug: t, index: i } = xt(),
          { slug: n } = Et();
        e && (t === n ? e.jumpTo(i - 1) : ((yt = !0), e.close())), St();
      },
      _t = () => {
        Ct && clearTimeout(Ct),
          queueMicrotask(() => {
    ...
    class Lt extends Ke {
      ...
      process(e, t) {
        return new Promise((i, n) => {
          ...
          if (("string" == typeof r && (r = ge(r)), !r || !Re(r))) {
            if (
    ...
    class Bt extends Ke {
      ...
      processType(e) {
        ...
        if (
          ...
          const s = $t(t, this.optionFor(e, zt)),
      ...
      setAspectRatio(e) {
        const t = e.contentEl;
        if (!(e.el && t && e.type && [It, zt, Rt].includes(e.type))) return;
        let i,
          n = e.width || "auto",
          s = e.height || "auto";
        if ("auto" === n || "auto" === s) {
    ...
    let Zt = class extends Ke {
      ...
      cleanup() {
        ...
        e.carousel && e.carousel.destroy(),
          ...
          (e.track = null),
          (e.state = Gt.Init),
          $e(e.instance.container, e.cn("hasThumbs"));
      }
      attach() {
        const e = this,
          t = e.instance;
    ...
    const ri = {
        Hash: class extends Ke {
          ...
          static destroy() {
            window.removeEventListener("hashchange", _t, !1);
          }
        },
        Html: Bt,
        Images: Lt,
    ...
    class Ii extends Pe {
      ...
      init() {
        ...
        this.option("Fullscreen.autoStart") && _i && !_i.isFullscreen()
          ? _i
              .request()
              .then(() => {
                (this.startedFs = !0), e();
      ...
      initLayout() {
        ...
        n &&
          ...
          (Mi && Pi) ||
            ...
            De(Mi, "fancybox-focus-guard"),
            Mi.setAttribute(wi, "0"),
            Mi.setAttribute(hi, "true"),
            Mi.setAttribute("aria-label", "Focus guard"),
            (Pi = Mi.cloneNode()),
          ...
          n.addEventListener("mousedown", (e) => {
            (Li = e.pageX), (Oi = e.pageY), $e(n, pi);
          }),
          this.option("animated") &&
            (De(n, fi),
            setTimeout(() => {
              this.isClosing() || $e(n, fi);
            }, 350)),
          this.emit("initLayout"));
      }
      initCarousel(e) {
        ...
        n.on("*", (e, t, ...i) => {
          ...
          n.on(["refresh", "change"], (e) => {
            ...
            if (!i) return;
            let n = i.downloadSrc || "";
            n || "image" !== i.type || i.error || !Si(i[xi]) || (n = i[xi]);
      ...
      onClick(e) {
        ...
        if (Math.abs(e.pageX - Li) > 30 || Math.abs(e.pageY - Oi) > 30) return;
      ...
      onKeydown(e) {
        ...
        if (
          ...
          return;
        if (
          ("Tab" === e.key ? De(this.container, pi) : $e(this.container, pi),
        ...
        e
          ? (!n || c.indexOf(n) < 0) &&
            ...
            c.length &&
              (i === Pi
                ? (u = c[0])
                : (this.lastFocus !== s && i !== Mi) || (u = c[c.length - 1])))
      ...
      close(e, t) {
        ...
        this.startedFs && _i && _i.isFullscreen()
          ? Promise.resolve(_i.exit()).then(() => n())
          : n();
      }
      clearIdle() {
      ...
      destroy() {
        ...
        i
          ...
          : (Mi && (Mi.remove(), (Mi = null)),
            ...
            $e(document.documentElement, li),
            (() => {
              if (!dt) return;
              const e = document,
                t = e.body;
              t.classList.remove(ci),
                t.style.setProperty(ui, ""),
      ...
      static fromNodes(e, t) {
        ...
        for (const n of e) {
          ...
          a &&
            ...
            o &&
              ((r = o.currentSrc || o[xi] || void 0),
              !r &&
                o.dataset &&
                (r = o.dataset.lazySrc || o.dataset[xi] || void 0));
          const l = {
            src: s,
            triggerEl: n,
            thumbEl: o,
    ...
    function $i(e, t, i) {
      ...
      s.setAttribute("href", `${t}#${i}`), n.appendChild(s), e.appendChild(n);
    }
    function Di({
      container: e,
      countries: t,
      spritePath: i = "./icons/sprite.svg",
      apiKey: n,
      defaultCountry: s,
    }) {
      const o = document.createElement("div");
      o.className = "phone-input-wrapper";
      const a = document.createElement("div");
      a.className = "country-dropdown";
      const r = document.createElement("button");
      (r.className = "current-country"), (r.type = "button");
      const l = document.createElement("div");
      l.className = "country-options";
      const c = e.dataset.name,
        d = e.dataset.id,
        u = e.dataset.clue,
        h = (e.dataset.value || "").trim();
      let p;
      u &&
        ((p = document.createElement("div")),
        p.classList.add("clue-input"),
        (p.textContent = u),
        o.appendChild(p));
      const f = zi(h),
        m = (function () {
          if (s) {
            const e = t.find((e) => e.code.toUpperCase() === s.toUpperCase());
            if (e) return { country: e, source: "default" };
          }
          if (f) {
            ...
            if (e) return { country: e, source: "value" };
          }
          return {
            country:
              t.find((e) => "NONE" === e.code) ||
              t.find((e) => "NA" === e.code) ||
              t[0],
            source: "fallback",
          };
        ...
        (l.textContent = ""),
          t.forEach((e) => {
            ...
            (t.type = "button"),
              ...
              (t.dataset.mask = e.mask),
              (t.dataset.dialCode = e.dialCode),
              $i(t, i, e.code);
            const n = document.createElement("span");
            (n.textContent = e.name),
              t.appendChild(n),
              t.classList.toggle("selected", e.code === g.code),
              l.appendChild(t);
          });
      }
      function C() {
        (r.textContent = ""), $i(r, i, g.code);
        const e = document.createElement("span");
        (e.textContent = "NONE" === g.code ? "" : g.code), r.appendChild(e);
      }
      ...
      if (
        ...
        if ("value" === m.source) {
          const t = zi(b);
          t && e.startsWith(t) && (e = e.slice(t.length));
        }
        E.value = v ? Ri(e, v) : e;
      } else E.value = y ? v : "";
      o.appendChild(E), e.appendChild(o);
      let x = v,
        S = b;
      function T() {
        if (!x || !S) return 0;
        const e = x.indexOf("_", zi(S).length);
        if (-1 !== e) return e;
        if (x.startsWith(S)) return S.length;
        const t = zi(S);
        if (!t) return 0;
        let i = 0;
        for (let e = 0; e < x.length; e++)
          if (/\d/.test(x[e]) && (i++, i === t.length)) return e + 1;
        return 0;
      }
      function _(e, t, i = !0) {
        e.setSelectionRange && (i && e.focus(), e.setSelectionRange(t, t));
      }
      let M = null;
      const P = (e) => {
          var t, i;
          ...
          const n = T();
          if (!n) return;
          const s = null !== (t = E.selectionStart) && void 0 !== t ? t : 0,
            o = null !== (i = E.selectionEnd) && void 0 !== i ? i : s;
          if (
            1 !== e.key.length ||
            e.ctrlKey ||
            e.metaKey ||
            ...
            return "Home" === e.key ||
              ...
              ("Backspace" === e.key && s <= n) ||
              ("Delete" === e.key && s < n)
              ? (e.preventDefault(), void _(E, n))
              : void (
                  ("Backspace" === e.key || "Delete" === e.key) &&
                  s < n &&
                  o > s &&
                  (e.preventDefault(), _(E, n))
                );
          E.setSelectionRange(n, Math.max(n, o));
        },
        L = () => {
          const e = E.selectionStart || 0;
          let t = zi(E.value);
          const i = zi(S);
          i && t.startsWith(i) && (t = t.slice(i.length));
          const n = x ? Ri(t, x) : t;
          E.value = n;
          let s = e;
          if ("Backspace" === M)
            for (; s > 0 && "_" !== n[s - 1] && /\D/.test(n[s - 1]); ) s--;
          else for (; s < n.length && "_" !== n[s] && /\D/.test(n[s]); ) s++;
          _(E, Math.max(s, T()));
        },
        O = () => {
          var e;
          const t = T(),
            i = null !== (e = E.selectionStart) && void 0 !== e ? e : 0;
          t && i < t && _(E, t, !1);
        },
        k = () => (null == p ? void 0 : p.classList.add("active")),
        A = () => (null == p ? void 0 : p.classList.remove("active"));
      ...
      const I = () => {
        ...
        z = (e) => {
          const i = e.target.closest(".country-option");
          if (!i) return;
          const n = i.dataset.code,
            s = i.dataset.mask,
            o = i.dataset.dialCode,
            a = t.find((e) => e.code === n);
          if (!a) return;
          l
          ...
          const r = E.value.indexOf("_", zi(S).length);
          _(E, -1 === r ? E.value.length : r, !0);
        };
      return (
        ...
        "fallback" === m.source &&
          (async function (e) {
            try {
              let i = "https://ipinfo.io/country";
              e && (i += `?token=${e}`);
              const n = await fetch(i);
              if (!n.ok) throw new Error(`HTTP error! status: ${n.status}`);
              const s = (await n.text()).trim().toUpperCase(),
                o = t.find((e) => e.code === s);
              if (!o) return;
              (g = o),
                (v = o.mask),
                ...
                (x = v),
                (S = b),
                h || ((E.placeholder = v), (E.value = y ? v : "")),
                C(),
                w();
              const a = E.value.indexOf("_", zi(S).length);
              _(E, -1 === a ? E.value.length : a, !1);
            } catch (e) {
              console.error("Geo detection failed:", e);
            }
          })(n),
        {
          addCountries: function (e) {
            const i = new Set(t.map((e) => e.code));
            e.forEach((e) => {
              i.has(e.code) || (t.push(e), i.add(e.code));
            }),
              w();
          },
          destroy: function () {
    ...
    const Bi = document.querySelectorAll(".phone-input"),
      Fi = [
        { name: "None Country", code: "NA", dialCode: "", mask: "" },
        {
          name: "Russia",
          code: "RU",
          dialCode: "+7",
        ...
        { name: "Egypt", code: "EG", dialCode: "+20", mask: "+20 ___ _______" },
        {
          name: "Cambodia",
          code: "KH",
          dialCode: "+855",
    ...
    Bi.forEach((e) => {
      Di({
        ...
        countries: Fi,
        spritePath:
          "/local/templates/antiage_redesign_v2_new/verstka_vlad_1/dist/images/sprite2.svg",
        apiKey: "",
        defaultCountry: "RU",
      });
    }),
    ...
    const ji = new IntersectionObserver(
      (e) => {
        e.forEach((e) => {
    ...
    if (
      (document.querySelector(".art-flex") &&
        ji.observe(document.querySelector(".art-flex")),
      document.querySelectorAll(".concept-item").forEach((e) => ji.observe(e)),
      (function () {
    ...
    !(function () {
      ...
      (function () {
        const e = document.querySelector("header"),
          t = (t, i = !0) => {
            const n =
              ...
              8;
            window.scrollTo({ top: n, behavior: i ? "smooth" : "auto" });
          },
          i = (e = !1) => {
        ...
        document.addEventListener("click", (e) => {
          ...
          const i = e.target.closest(".anchor");
          if (!i) return;
